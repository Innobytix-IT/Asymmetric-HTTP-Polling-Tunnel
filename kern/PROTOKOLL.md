...
**Am 03.09.2026 nachgemessen:** Apache 2.4 nimmt die Aenderungszeit mit
Unterauflaesung in den ETag (gemessen auf bplaced und IONOS: zwei gleich
grosse Schreibvorgaenge in derselben Sekunde ergaben verschiedene ETags).
Auf solchen Hostern tritt die Kollision **nicht** auf. Die drei Punkte
bleiben Pflicht, weil ein Agent nicht wissen kann, auf welchem Dateisystem
sein Vermittler liegt -- aber sie sind Vorsorge, nicht Reparatur eines dort
belegten Fehlers.
