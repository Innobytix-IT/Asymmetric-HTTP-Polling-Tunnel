...
#
# Beispiel:
#     bash ausliefern.sh innobytix-it.bplaced.net /www/ahpt \
#          https://innobytix-it.bplaced.net/ahpt ~/ahpt-auslieferung \
#          ~/.ahpt/bplaced.pin
#
...
if [ -z "$HOST" ] || [ -z "$FERN" ] || [ -z "$BASIS" ] || [ -z "$QUELLE" ]; then
    ...
    echo ""
    echo "Beispiel:"
    echo "  bash ausliefern.sh innobytix-it.bplaced.net /www/ahpt \\"
    echo "       https://innobytix-it.bplaced.net/ahpt ~/ahpt-auslieferung \\"
